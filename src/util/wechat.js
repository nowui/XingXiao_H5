...
function auth() {
  ...
  if (open_id == '') {
    ...
    if (token == '') {
      window.location.href = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx26c8db6f1987e4e0&redirect_uri=http%3A%2F%2Fapi.xingxiao.nowui.com%2Fwechat%2Fapi%2Fauth%3Furl%3Dhome%26platform%3D' + constant.platform + '%26version%3D' + constant.version + '&response_type=code&scope=snsapi_base&state=123#wechat_redirect';
    }
  } else {
    if (open_id != '') {
